// Generated by gencpp from file ff_msgs/PerchState.msg
// DO NOT EDIT!


#ifndef FF_MSGS_MESSAGE_PERCHSTATE_H
#define FF_MSGS_MESSAGE_PERCHSTATE_H
...
struct PerchState_
{
  typedef PerchState_<ContainerAllocator> Type;
  ...
  PerchState_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , state(0)
    , fsm_event(_alloc)
    , fsm_state(_alloc)  {
  ...
  typedef boost::shared_ptr< ::ff_msgs::PerchState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ff_msgs::PerchState_<ContainerAllocator> const> ConstPtr;

}; // struct PerchState_

typedef ::ff_msgs::PerchState_<std::allocator<void> > PerchState;

typedef boost::shared_ptr< ::ff_msgs::PerchState > PerchStatePtr;
typedef boost::shared_ptr< ::ff_msgs::PerchState const> PerchStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ff_msgs::PerchState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ff_msgs::PerchState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ff_msgs::PerchState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ff_msgs::PerchState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ff_msgs::PerchState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ff_msgs::PerchState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ff_msgs::PerchState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ff_msgs::PerchState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ff_msgs::PerchState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ff_msgs::PerchState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5a3bc3d43070c3cbULL;
  static const uint64_t static_value2 = 0x7655a2601ea68801ULL;
};

template<class ContainerAllocator>
struct DataType< ::ff_msgs::PerchState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ff_msgs::PerchState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ff_msgs::PerchState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ff_msgs::PerchState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ff_msgs::PerchState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // FF_MSGS_MESSAGE_PERCHSTATE_H
