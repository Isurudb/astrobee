// Generated by gencpp from file ff_msgs/MotionAction.msg
// DO NOT EDIT!


#ifndef FF_MSGS_MESSAGE_MOTIONACTION_H
#define FF_MSGS_MESSAGE_MOTIONACTION_H
...
#include <ff_msgs/MotionActionGoal.h>
...
struct MotionAction_
{
  ...
  (void)_alloc;
   ...
   typedef  ::ff_msgs::MotionActionGoal_<ContainerAllocator>  _action_goal_type;
  _action_goal_type action_goal;

   typedef  ::ff_msgs::MotionActionResult_<ContainerAllocator>  _action_result_type;
  _action_result_type action_result;

   typedef  ::ff_msgs::MotionActionFeedback_<ContainerAllocator>  _action_feedback_type;
  ...
  typedef boost::shared_ptr< ::ff_msgs::MotionAction_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ff_msgs::MotionAction_<ContainerAllocator> const> ConstPtr;

}; // struct MotionAction_

typedef ::ff_msgs::MotionAction_<std::allocator<void> > MotionAction;

typedef boost::shared_ptr< ::ff_msgs::MotionAction > MotionActionPtr;
typedef boost::shared_ptr< ::ff_msgs::MotionAction const> MotionActionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ff_msgs::MotionAction_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ff_msgs::MotionAction_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ff_msgs::MotionAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ff_msgs::MotionAction_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ff_msgs::MotionAction_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ff_msgs::MotionAction_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ff_msgs::MotionAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ff_msgs::MotionAction_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ff_msgs::MotionAction_<ContainerAllocator> >
{
  static const char* value()
  {
    return "cf997e3db0df27f9ff7739394388cdf4";
  }

  static const char* value(const ::ff_msgs::MotionAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xcf997e3db0df27f9ULL;
  static const uint64_t static_value2 = 0xff7739394388cdf4ULL;
};

template<class ContainerAllocator>
struct DataType< ::ff_msgs::MotionAction_<ContainerAllocator> >
{
  static const char* value()
  {
    return "ff_msgs/MotionAction";
  }
...
template<class ContainerAllocator>
struct Definition< ::ff_msgs::MotionAction_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ff_msgs::MotionAction_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ff_msgs::MotionAction_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ff_msgs::MotionAction_<ContainerAllocator>& v)
  {
    s << indent << "action_goal: ";
    s << std::endl;
    Printer< ::ff_msgs::MotionActionGoal_<ContainerAllocator> >::stream(s, indent + "  ", v.action_goal);
    s << indent << "action_result: ";
    s << std::endl;
    Printer< ::ff_msgs::MotionActionResult_<ContainerAllocator> >::stream(s, indent + "  ", v.action_result);
    s << indent << "action_feedback: ";
    s << std::endl;
    Printer< ::ff_msgs::MotionActionFeedback_<ContainerAllocator> >::stream(s, indent + "  ", v.action_feedback);
  }
};
...
#endif // FF_MSGS_MESSAGE_MOTIONACTION_H
