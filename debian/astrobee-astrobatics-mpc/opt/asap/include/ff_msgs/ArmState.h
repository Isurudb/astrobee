// Generated by gencpp from file ff_msgs/ArmState.msg
// DO NOT EDIT!


#ifndef FF_MSGS_MESSAGE_ARMSTATE_H
#define FF_MSGS_MESSAGE_ARMSTATE_H
...
struct ArmState_
{
  ...
  typedef boost::shared_ptr< ::ff_msgs::ArmState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ff_msgs::ArmState_<ContainerAllocator> const> ConstPtr;

}; // struct ArmState_

typedef ::ff_msgs::ArmState_<std::allocator<void> > ArmState;

typedef boost::shared_ptr< ::ff_msgs::ArmState > ArmStatePtr;
typedef boost::shared_ptr< ::ff_msgs::ArmState const> ArmStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ff_msgs::ArmState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ff_msgs::ArmState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ff_msgs::ArmState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ff_msgs::ArmState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ff_msgs::ArmState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ff_msgs::ArmState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ff_msgs::ArmState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ff_msgs::ArmState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ff_msgs::ArmState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ff_msgs::ArmState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4424d991014c0bf2ULL;
  static const uint64_t static_value2 = 0xf6a1521cbeb69659ULL;
};

template<class ContainerAllocator>
struct DataType< ::ff_msgs::ArmState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ff_msgs::ArmState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ff_msgs::ArmState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ff_msgs::ArmState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ff_msgs::ArmState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // FF_MSGS_MESSAGE_ARMSTATE_H
