...
if("FALSE" STREQUAL "TRUE")
  set(coordinator_SOURCE_PREFIX /home/isuru/Forked_astrobee/astrobee/src/asap/coordinator)
  set(coordinator_DEVEL_PREFIX /home/isuru/Forked_astrobee/astrobee/debian/devel/.private/coordinator)
  ...
  set(coordinator_INSTALL_PREFIX /home/isuru/Forked_astrobee/astrobee/src/debian/tmp/opt/asap)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'coordinator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/isuru/Forked_astrobee/astrobee/src/debian/tmp/opt/asap/${idir}'.  ${_report}")
    endif()
    _list_append_unique(coordinator_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "PrimaryNodelet;SecondaryNodelet")
...
set(depends "roscpp;nodelet;pluginlib;actionlib;tf;ff_msgs;ff_util;std_msgs;geometry_msgs;ff_common;ff_nodelet;msg_conversions;ff_flight")
