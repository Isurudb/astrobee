...
class PerchActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PerchResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PerchResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PerchActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = PerchResult.Resolve(msg.result)
    }
    else {
      resolved.result = new PerchResult()
    }
...
module.exports = PerchActionResult;
