...
class LocalizationGraph {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('serialized_graph')) {
        this.serialized_graph = initObj.serialized_graph
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [serialized_graph]
    bufferOffset = _serializer.string(obj.serialized_graph, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LocalizationGraph(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [child_frame_id]
    data.child_frame_id = _deserializer.string(buffer, bufferOffset);
    // Deserialize message field [serialized_graph]
    data.serialized_graph = _deserializer.string(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += object.serialized_graph.length;
    return length + 8;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LocalizationGraph(null);
    ...
    if (msg.serialized_graph !== undefined) {
      resolved.serialized_graph = msg.serialized_graph;
    }
    else {
      resolved.serialized_graph = ''
    }
...
module.exports = LocalizationGraph;
