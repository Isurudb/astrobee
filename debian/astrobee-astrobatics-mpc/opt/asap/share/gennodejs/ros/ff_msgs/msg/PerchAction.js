...
class PerchAction {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('action_goal')) {
        ...
        this.action_goal = new PerchActionGoal();
      }
      if (initObj.hasOwnProperty('action_result')) {
        this.action_result = initObj.action_result
      }
      else {
        this.action_result = new PerchActionResult();
      }
      if (initObj.hasOwnProperty('action_feedback')) {
        this.action_feedback = initObj.action_feedback
      }
      else {
        this.action_feedback = new PerchActionFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PerchAction
    // Serialize message field [action_goal]
    bufferOffset = PerchActionGoal.serialize(obj.action_goal, buffer, bufferOffset);
    // Serialize message field [action_result]
    bufferOffset = PerchActionResult.serialize(obj.action_result, buffer, bufferOffset);
    // Serialize message field [action_feedback]
    bufferOffset = PerchActionFeedback.serialize(obj.action_feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PerchAction
    let len;
    let data = new PerchAction(null);
    // Deserialize message field [action_goal]
    data.action_goal = PerchActionGoal.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_result]
    data.action_result = PerchActionResult.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_feedback]
    data.action_feedback = PerchActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += PerchActionGoal.getMessageSize(object.action_goal);
    length += PerchActionResult.getMessageSize(object.action_result);
    length += PerchActionFeedback.getMessageSize(object.action_feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PerchAction(null);
    if (msg.action_goal !== undefined) {
      resolved.action_goal = PerchActionGoal.Resolve(msg.action_goal)
    }
    else {
      resolved.action_goal = new PerchActionGoal()
    }

    if (msg.action_result !== undefined) {
      resolved.action_result = PerchActionResult.Resolve(msg.action_result)
    }
    else {
      resolved.action_result = new PerchActionResult()
    }

    if (msg.action_feedback !== undefined) {
      resolved.action_feedback = PerchActionFeedback.Resolve(msg.action_feedback)
    }
    else {
      resolved.action_feedback = new PerchActionFeedback()
    }
