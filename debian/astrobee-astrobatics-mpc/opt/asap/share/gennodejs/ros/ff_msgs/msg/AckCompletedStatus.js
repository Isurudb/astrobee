...
class AckCompletedStatus {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new AckCompletedStatus(null);
  ...
  static datatype() {
    ...
    return 'ff_msgs/AckCompletedStatus';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '06cb8fd59f3394d8700f8f7e1d9d75a3';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new AckCompletedStatus(null);
...
module.exports = AckCompletedStatus;
