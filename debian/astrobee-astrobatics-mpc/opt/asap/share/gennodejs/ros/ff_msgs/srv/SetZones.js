...
class SetZonesRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetZonesRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetZonesRequest
    let len;
    let data = new SetZonesRequest(null);
  ...
  static datatype() {
    ...
    return 'ff_msgs/SetZonesRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetZonesRequest(null);
...
class SetZonesResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetZonesResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetZonesResponse
    let len;
    let data = new SetZonesResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetZonesResponse(null);
...
module.exports = {
  Request: SetZonesRequest,
  Response: SetZonesResponse,
  md5sum() { return '409154f0ce409359cbde795e43243c62'; },
  datatype() { return 'ff_msgs/SetZones'; }
};
