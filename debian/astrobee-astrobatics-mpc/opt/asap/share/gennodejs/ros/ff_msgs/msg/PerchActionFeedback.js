...
class PerchActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new PerchFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PerchFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PerchActionFeedback(null);
    ...
    data.feedback = PerchFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PerchFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PerchActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PerchFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PerchFeedback()
    }
...
module.exports = PerchActionFeedback;
