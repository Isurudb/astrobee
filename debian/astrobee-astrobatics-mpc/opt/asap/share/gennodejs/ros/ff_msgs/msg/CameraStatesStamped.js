...
class CameraStatesStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CameraStatesStamped(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.states[i] = CameraState.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.states.forEach((val) => {
      length += CameraState.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static datatype() {
    ...
    return 'ff_msgs/CameraStatesStamped';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '8196b4a79fabfdcae8f271a13d0b1973';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CameraStatesStamped(null);
    ...
    if (msg.states !== undefined) {
      ...
      for (let i = 0; i < resolved.states.length; ++i) {
        resolved.states[i] = CameraState.Resolve(msg.states[i]);
      }
    }
    else {
      resolved.states = []
...
module.exports = CameraStatesStamped;
