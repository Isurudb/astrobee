...
(cl:defclass <MotionResult> (roslisp-msg-protocol:ros-message)
  ((response
   ...
   (flight_mode
    :reader flight_mode
    :initarg :flight_mode
    :type ff_msgs-msg:FlightMode
    :initform (cl:make-instance 'ff_msgs-msg:FlightMode))
   (segment
    :reader segment
    :initarg :segment
...
(cl:defmethod cl:initialize-instance :after ((m <MotionResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotionResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ff_msgs-msg:<MotionResult> is deprecated: use ff_msgs-msg:MotionResult instead.")))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <MotionResult>))
...
(cl:defmethod fsm_result-val ((m <MotionResult>))
...
(cl:defmethod flight_mode-val ((m <MotionResult>))
...
(cl:defmethod segment-val ((m <MotionResult>))
  ...
  (segment m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<MotionResult>)))
    "Constants for message type '<MotionResult>"
  '((:ALREADY_THERE . 2)
    (:SUCCESS . 1)
    (:PREEMPTED . 0)
    (:PLAN_FAILED . -1)
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MotionResult>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'flight_mode) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MotionResult>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'flight_mode) istream)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MotionResult>)))
  ...
  "d9085ddc2b12a9c56a85552d7ec1a05e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MotionResult)))
  "Returns md5sum for a message object of type 'MotionResult"
  "d9085ddc2b12a9c56a85552d7ec1a05e")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MotionResult>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'flight_mode))
