...
(cl:defclass <VisualLandmarks> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
   ...
   (landmarks
    :reader landmarks
    :initarg :landmarks
    :type (cl:vector ff_msgs-msg:VisualLandmark)
   :initform (cl:make-array 0 :element-type 'ff_msgs-msg:VisualLandmark :initial-element (cl:make-instance 'ff_msgs-msg:VisualLandmark))))
)

(cl:defclass VisualLandmarks (<VisualLandmarks>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <VisualLandmarks>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'VisualLandmarks)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ff_msgs-msg:<VisualLandmarks> is deprecated: use ff_msgs-msg:VisualLandmarks instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <VisualLandmarks>))
...
(cl:defmethod camera_id-val ((m <VisualLandmarks>))
...
(cl:defmethod pose-val ((m <VisualLandmarks>))
...
(cl:defmethod landmarks-val ((m <VisualLandmarks>))
  ...
  (landmarks m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <VisualLandmarks>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VisualLandmarks>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'landmarks)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ff_msgs-msg:VisualLandmark))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<VisualLandmarks>)))
  "Returns string type for a message object of type '<VisualLandmarks>"
  "ff_msgs/VisualLandmarks")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'VisualLandmarks)))
  "Returns string type for a message object of type 'VisualLandmarks"
  "ff_msgs/VisualLandmarks")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VisualLandmarks>)))
  "Returns md5sum for a message object of type '<VisualLandmarks>"
  "bc9fc09f69d7758225ed41ee26f6375e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VisualLandmarks)))
  "Returns md5sum for a message object of type 'VisualLandmarks"
  "bc9fc09f69d7758225ed41ee26f6375e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VisualLandmarks>)))
  "Returns full string definition for message of type '<VisualLandmarks>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VisualLandmarks)))
  "Returns full string definition for message of type 'VisualLandmarks"
  (cl:format cl:nil "# Copyright (c) 2017, United States Government, as represented by the~%# Administrator of the National Aeronautics and Space Administration.~%# ~%# All rights reserved.~%# ~%# The Astrobee platform is licensed under the Apache License, Version 2.0~%# (the \"License\"); you may not use this file except in compliance with the~%# License. You may obtain a copy of the License at~%# ~%#     http://www.apache.org/licenses/LICENSE-2.0~%# ~%# Unless required by applicable law or agreed to in writing, software~%# distributed under the License is distributed on an \"AS IS\" BASIS, WITHOUT~%# WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See the~%# License for the specific language governing permissions and limitations~%# under the License.~%#~%# The observation from a camera image, of image coordinates~%# and associated 3D coordinates. Used for sparse mapping and AR tags.~%~%Header header # header with timestamp~%uint32 camera_id # image ID, associated with registration pulse~%geometry_msgs/Pose pose # estimated camera pose from features~%ff_msgs/VisualLandmark[] landmarks # list of all landmarks~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: ff_msgs/VisualLandmark~%# Copyright (c) 2017, United States Government, as represented by the~%# Administrator of the National Aeronautics and Space Administration.~%# ~%# All rights reserved.~%# ~%# The Astrobee platform is licensed under the Apache License, Version 2.0~%# (the \"License\"); you may not use this file except in compliance with the~%# License. You may obtain a copy of the License at~%# ~%#     http://www.apache.org/licenses/LICENSE-2.0~%# ~%# Unless required by applicable law or agreed to in writing, software~%# distributed under the License is distributed on an \"AS IS\" BASIS, WITHOUT~%# WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See the~%# License for the specific language governing permissions and limitations~%# under the License.~%#~%# A single observation of a feature, with an image coordinate~%# and known 3D coordinate~%~%float32 x # known 3D position x~%float32 y # known 3D position y~%float32 z # known 3D position z~%float32 u # feature image coordinate x~%float32 v # feature image coordinate y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <VisualLandmarks>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <VisualLandmarks>))
  "Converts a ROS message object to a list"
  (cl:list 'VisualLandmarks
