...
(cl:defclass <Heartbeat> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (nodelet_manager
    :reader nodelet_manager
    :initarg :nodelet_manager
    :type cl:string
    :initform "")
   (node
    :reader node
...
(cl:defmethod cl:initialize-instance :after ((m <Heartbeat>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Heartbeat)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ff_msgs-msg:<Heartbeat> is deprecated: use ff_msgs-msg:Heartbeat instead.")))
...
(cl:ensure-generic-function 'nodelet_manager-val :lambda-list '(m))
(cl:defmethod nodelet_manager-val ((m <Heartbeat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ff_msgs-msg:nodelet_manager-val is deprecated.  Use ff_msgs-msg:nodelet_manager instead.")
  (nodelet_manager m))

(cl:ensure-generic-function 'node-val :lambda-list '(m))
(cl:defmethod node-val ((m <Heartbeat>))
...
(cl:defmethod faults-val ((m <Heartbeat>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Heartbeat>) ostream)
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'nodelet_manager))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'nodelet_manager))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Heartbeat>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:slot-value msg 'nodelet_manager) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'nodelet_manager) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
    (cl:let ((__ros_str_len 0))
      (cl:setf (cl:ldb (cl:byte 8 0) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Heartbeat>)))
  ...
  "00da4d5a529de9d778f78787c87e306c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Heartbeat)))
  "Returns md5sum for a message object of type 'Heartbeat"
  "00da4d5a529de9d778f78787c87e306c")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Heartbeat>))
  (cl:+ 0
     ...
     4 (cl:length (cl:slot-value msg 'nodelet_manager))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Heartbeat>))
  ...
  (cl:list 'Heartbeat
    ...
    (cl:cons ':nodelet_manager (nodelet_manager msg))
