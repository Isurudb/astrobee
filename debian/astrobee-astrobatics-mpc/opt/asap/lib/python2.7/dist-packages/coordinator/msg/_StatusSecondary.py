...
"""autogenerated by genpy from coordinator/StatusSecondary.msg. Do not edit."""
import sys
...
class StatusSecondary(genpy.Message):
  _md5sum = "73edc0983b4cd83de63e2948253578db"
  _type = "coordinator/StatusSecondary"
...
# StatusSecondary"""
  __slots__ = ['stamp','test_number','default_control','flight_mode','test_finished','coord_ok']
  _slot_types = ['time','int32','bool','string','bool','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       stamp,test_number,default_control,flight_mode,test_finished,coord_ok
    ...
    """
    if args or kwds:
      super(StatusSecondary, self).__init__(*args, **kwds)
