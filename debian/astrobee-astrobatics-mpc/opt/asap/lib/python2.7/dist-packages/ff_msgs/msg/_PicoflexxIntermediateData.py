...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.pack(pattern, *self.exposure))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.exposure = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.raw.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.raw.encoding = str[start:end].decode('utf-8')
      else:
