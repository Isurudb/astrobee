...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_i().pack(self.state.state))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.state.pipeline.mode))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.state.pipeline.id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.state.pipeline.name = str[start:end].decode('utf-8')
      else:
