...
class FlightMode(genpy.Message):
  _md5sum = "0bb389101a5f30087bd644e6596d8e8e"
...
float64 z"""
  ...
  __slots__ = ['header','name','control_enabled','tolerance_pos_endpoint','tolerance_pos','tolerance_vel','tolerance_att','tolerance_omega','tolerance_time','att_kp','att_ki','omega_kd','pos_kp','pos_ki','vel_kd','hard_limit_vel','hard_limit_accel','hard_limit_omega','hard_limit_alpha','speed']
  _slot_types = ['std_msgs/Header','string','bool','float32','float32','float32','float32','float32','float32','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','float32','float32','float32','float32','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,control_enabled,tolerance_pos_endpoint,tolerance_pos,tolerance_vel,tolerance_att,tolerance_omega,tolerance_time,att_kp,att_ki,omega_kd,pos_kp,pos_ki,vel_kd,hard_limit_vel,hard_limit_accel,hard_limit_omega,hard_limit_alpha,speed
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_B6f18d4fB().pack(_x.control_enabled, _x.tolerance_pos_endpoint, _x.tolerance_pos, _x.tolerance_vel, _x.tolerance_att, _x.tolerance_omega, _x.tolerance_time, _x.att_kp.x, _x.att_kp.y, _x.att_kp.z, _x.att_ki.x, _x.att_ki.y, _x.att_ki.z, _x.omega_kd.x, _x.omega_kd.y, _x.omega_kd.z, _x.pos_kp.x, _x.pos_kp.y, _x.pos_kp.z, _x.pos_ki.x, _x.pos_ki.y, _x.pos_ki.z, _x.vel_kd.x, _x.vel_kd.y, _x.vel_kd.z, _x.hard_limit_vel, _x.hard_limit_accel, _x.hard_limit_omega, _x.hard_limit_alpha, _x.speed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.control_enabled, _x.tolerance_pos_endpoint, _x.tolerance_pos, _x.tolerance_vel, _x.tolerance_att, _x.tolerance_omega, _x.tolerance_time, _x.att_kp.x, _x.att_kp.y, _x.att_kp.z, _x.att_ki.x, _x.att_ki.y, _x.att_ki.z, _x.omega_kd.x, _x.omega_kd.y, _x.omega_kd.z, _x.pos_kp.x, _x.pos_kp.y, _x.pos_kp.z, _x.pos_ki.x, _x.pos_ki.y, _x.pos_ki.z, _x.vel_kd.x, _x.vel_kd.y, _x.vel_kd.z, _x.hard_limit_vel, _x.hard_limit_accel, _x.hard_limit_omega, _x.hard_limit_alpha, _x.speed,) = _get_struct_B6f18d4fB().unpack(str[start:end])
