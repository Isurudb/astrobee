...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.pipeline.mode))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.fsm_event = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.fsm_state = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.pipeline.id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.pipeline.name = str[start:end].decode('utf-8')
      else:
