...
FSW_SIM_TOPICS = create_namespaced_topics(FSW_TOPICS, sim=True, bee_name="wannabee")
...
SIM_ONLY_TOPICS = create_namespaced_topics(SIM_ONLY, sim=True, bee_name="wannabee")
...
SAMPLE_SIM_PRIMARY_TOPICS = create_namespaced_topics(SAMPLE_PRIMARY, sim=True, bee_name="wannabee")
